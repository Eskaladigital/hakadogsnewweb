...
-- PASO 2: Insertar badges más útiles y realistas
...
UPDATE badges SET description = 'Has estudiado durante 7 días consecutivos. ¡Qué constancia!' WHERE code = 'streak_7_days';
UPDATE badges SET description = 'Has estudiado durante 30 días consecutivos. ¡Impresionante racha!' WHERE code = 'streak_30_days';
UPDATE badges SET description = 'Has estudiado durante 100 días consecutivos. ¡Eres imparable!' WHERE code = 'streak_100_days';
