          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-forest-dark mb-6">
                Alfredo García
                <span className="block text-3xl md:text-4xl text-sage mt-2">Educador Canino Profesional</span>
              </h1>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                ...
                <div className="text-center">
                  <div className="text-4xl font-bold text-forest">11+</div>
            ...
            <div className="relative">
              ...
              {/* Badges flotantes */}
              <div className="absolute -top-4 -right-4 bg-gold text-forest-dark px-6 py-3 rounded-2xl shadow-xl font-bold text-center">
                <div className="text-2xl">BE HAKA</div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-forest/10 to-sage/10 rounded-3xl p-8 border-2 border-forest/20">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-14 h-14 bg-forest/10 rounded-xl flex items-center justify-center">
                  <MapPin className="text-forest" size={28} />
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-forest-dark">Servicios Presenciales</h3>
                  <p className="text-sm text-gray-600">Archena y alrededores (40 km)</p>
                </div>
              </div>
